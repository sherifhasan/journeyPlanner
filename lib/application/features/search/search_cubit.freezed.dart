...
class _$_Data implements _Data {
  const _$_Data(final List<LocationModel> locations) : _locations = locations;
  ...
  @override
  String toString() {
    return 'SearchState.data(locations: $locations)';
  }
...
abstract class _Data implements SearchState {
  const factory _Data(final List<LocationModel> locations) = _$_Data;
